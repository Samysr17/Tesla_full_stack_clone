...
function Section2() {
  return (
    <div  className="section2 bg-no-repeat h-screen w-screen font-sans bg-cover bg-center flex-col">
      <div className='p-[15vh] text-center '>
        <Fade bottom>
    <h1 className="md:text-5xl text-3xl hover:ease-in duration-300 hover:text-4xl cursor-pointer ">Model Y</h1>  
    <p className=" mt-4 md:text-sm cursor-pointer ">Check Inventory</p>
    </Fade>
    </div>
